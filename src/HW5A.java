public class HW5A {
    ...
    public void task5A4(int day) {
        switch(day){
            ...
            default:System.out.println("Type number from 1 to 7");
        }

    }
    public void task5A5(int xCord, int yCord) {
        if(xCord==0 && yCord == 0)  System.out.println("Point (" + xCord + ";" + yCord + ") lies at the origin");
        else if(xCord>0 && yCord == 0)  System.out.println("Point (" + xCord + ";" + yCord + ") lies between the first and fourth quadrant");
        else if(xCord<0 && yCord == 0)  System.out.println("Point (" + xCord + ";"+ yCord + ") lies between the second and third quadrant");
        else if(xCord==0 && yCord > 0)  System.out.println("Point (" + xCord + ";" + yCord + ") lies between the first and second quadrant");
        else if(xCord==0 && yCord < 0)  System.out.println("Point (" + xCord + ";" + yCord + ") lies between the third and fourth quadrant");
        else if (xCord>0 && yCord>0) System.out.println("Point (" + xCord + ";"+  yCord + ") lies in first quadrant");
        else if (xCord<0 && yCord>0) System.out.println("Point (" + xCord + ";" + yCord + ") lies in second quadrant");
        else if (xCord<0 && yCord<0) System.out.println("Point (" + xCord + ";" + yCord + ") lies in third quadrant");
        else if (xCord>0 && yCord<0) System.out.println("Point (" + xCord +";" + yCord + ") lies in fourth quadrant");
    }
